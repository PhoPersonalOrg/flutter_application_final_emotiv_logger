...
## 2026-07-12 - Add empty state to ScannerWidget list
...
**Action:** When mapping over dynamic lists for UI rendering, check for `.isEmpty` and provide an explicit fallback widget to guide the user.
