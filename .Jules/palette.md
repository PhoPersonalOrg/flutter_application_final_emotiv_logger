...
## 2026-07-15 - Add Empty State for Found Devices
**Learning:** Dynamic lists populated by streams need fallback UI or empty state messages to improve feedback visibility when results are empty.
**Action:** Implemented a helpful empty state message for the ScannerWidget's device list.
