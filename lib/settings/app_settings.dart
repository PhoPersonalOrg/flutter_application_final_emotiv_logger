...
class AppSettings {
  ...
  AppSettings copyWith({
    ...
    return AppSettings(
      useNetworkStream: useNetworkStream ?? this.useNetworkStream,
  ...
  Map<String, Object?> toJson() {
    return <String, Object?>{
      'useNetworkStream': useNetworkStream,
      'networkHost': networkHost,
      'networkPort': networkPort,
      'networkProtocol': networkProtocol.storageValue,
    };
  }

  static AppSettings fromJson(Map<String, Object?> json) {
    return AppSettings(
      useNetworkStream: (json['useNetworkStream'] as bool?) ?? false,
      networkHost: (json['networkHost'] as String?) ?? defaultHost,
      networkPort: (json['networkPort'] as int?) ?? defaultPort,
      networkProtocol: NetworkProtocolExtension.fromStorage(
        json['networkProtocol'] as String?,
      ),
    );
  }
}
...
class AppSettingsRepository {
  ...
  Future<AppSettings> load() async {
    ...
    return AppSettings(
      useNetworkStream: prefs.getBool(_useNetworkStreamKey) ?? false,
      networkHost: prefs.getString(_networkHostKey) ?? AppSettings.defaultHost,
      networkPort: prefs.getInt(_networkPortKey) ?? AppSettings.defaultPort,
      networkProtocol: NetworkProtocolExtension.fromStorage(
        prefs.getString(_networkProtocolKey),
      ),
    );
  }
  ...
  Future<void> save(AppSettings settings) async {
    ...
    await prefs.setString(
      _networkProtocolKey,
      settings.networkProtocol.storageValue,
    );
  }
}
